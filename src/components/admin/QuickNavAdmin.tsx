...
export default function QuickNavAdmin() {
  ...
  // States and handlers for gamified image vault chests in preview
                        ...
                        <div className="text-center font-extrabold py-8" style={{
                          ...
                          <div className="w-full">
                            <style dangerouslySetInnerHTML={{ __html: `
                              @keyframes chestWiggleAdmin {
                                0%, 100% { transform: rotate(0deg) scale(1); }
                                20%, 60% { transform: rotate(-4deg) scale(1.03); }
                                40%, 80% { transform: rotate(4deg) scale(1.03); }
                              }
                              @keyframes chestOpenAdmin {
                                0% { transform: scale(1) rotate(0deg); filter: brightness(1); }
                                50% { transform: scale(1.1) rotate(-8deg); filter: brightness(1.5) drop-shadow(0 0 15px rgba(234,179,8,0.8)); }
                                100% { transform: scale(0) rotate(15deg); opacity: 0; }
                              }
                              .cr-chest-wiggle-admin:hover .cr-chest-svg-admin {
                                animation: chestWiggleAdmin 0.4s ease-in-out infinite;
                              }
                              .cr-chest-opening-admin {
                                animation: chestOpenAdmin 0.6s cubic-bezier(.36,.07,.19,.97) forwards;
                                pointer-events: none;
                              }
                            `}} />

                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                              {(quickNavData.photos || []).map((photo, idx: number) => (
                                unlockedChests[photo.id] ? (
                                  ...
                                  <div
                                    ...
                                    className={`relative aspect-[4/3] sm:aspect-square flex flex-col justify-center items-center rounded-xl cursor-pointer transition-all duration-300 select-none group cr-chest-wiggle-admin ${openingChests[photo.id] ? "cr-chest-opening-admin" : ""}`}
                                    style={{
                                      background: "transparent",
                                      border: "none",
                                      boxShadow: "none",
                                  ...
                                  >
                                    ...
                                    <div className="relative z-10 flex flex-col items-center gap-2 cr-chest-svg-admin">
                                      <svg viewBox="0 0 24 24" fill="none" className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 shrink-0 transition-transform duration-300 group-hover:scale-105">
                                        <path d="M4 10V7a3 3 0 0 1 3-3h10a3 3 0 0 1 3 3v3H4Z" fill="url(#lidGradAdmin)" stroke="#eab308" strokeWidth="1.5" />
                                        <path d="M4 10v7a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3v-7H4Z" fill="url(#baseGradAdmin)" stroke="#eab308" strokeWidth="1.5" />
                                        ...
                                        <defs>
                                          <linearGradient id="lidGradAdmin" x1="0" y1="0" x2="0" y2="1">
                                            <stop offset="0%" stopColor="#f59e0b" />
                                            <stop offset="100%" stopColor="#d97706" />
                                          </linearGradient>
                                          <linearGradient id="baseGradAdmin" x1="0" y1="0" x2="0" y2="1">
