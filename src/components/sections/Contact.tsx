...
import { getContactData, type ContactData } from "@/lib/contact-data";
...
export default function Contact() {
  ...
  useEffect(() => {
    const loadContactData = async () => {
      try {
        setLoading(true);
        console.log("[Contact] Loading data from Firebase...");
    ...
    <div className="mt-4">
      ...
      >
        ...
        >
          ...
          />
          {/* Header */}
          <div className="px-2 sm:px-3 py-1 rounded-lg text-black font-extrabold text-sm sm:text-base"
            style={{
          ...
          <div className="mt-2 grid gap-3">
            ...
            <div>
              <a
                ...
                className="group mt-1 inline-flex items-center gap-1.5 sm:gap-2 rounded-md px-2 sm:px-2.5 py-1.5 text-xs sm:text-sm text-black font-extrabold hover:brightness-[1.06]"
                style={{
