...
export default function FontToggleFab() {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-20 z-[1050] grid place-items-center rounded-full shadow-lg active:translate-y-0.5 transition focus:outline-none focus:ring-2 focus:ring-yellow-400"
      style={{
        width: 52,
        height: 52,
        background:
